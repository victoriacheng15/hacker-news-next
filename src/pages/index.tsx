...
export default function Home() {
	...
	return (
		<>
			<MetaHead title="Home | Hacker News Clone - Next.js" description="A Hacker News clone with Next.js, Redux Toolkit, and Chakra UI that can read 8 latest recent stories for top, show and job stories." />
			<MainContainer>
